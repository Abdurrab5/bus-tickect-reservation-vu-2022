...
<head>
	...
	<div class="container">
	<div class="sidebar">
	 <a href=" " style="color:#b8cfcd;border:none;text-transform:uppercase" ><?php echo $_SESSION['admin']?> </a> 
		 
		<div class=" btn-group-sm">
		<table class="table table-bordered">
	 	<tr><a href="dashboard.php" class="btn btn-dark" role="button">Dashboard</a>	</tr>	
		<a href="bus.php" class="btn btn-dark" role="button">Buses</a>
		<a href="route.php" class="btn btn-dark" role="button">Schedule</a>
		<a href="bookings.php" class="btn btn-secondary" role="button">Booking</a>
		<a href="seats.php" class="btn btn-secondary" role="button">Seats</a>
		<a href="seats_request.php" class="btn btn-light" role="button"> Seats Request</a>
		<a href="change_fair.php" class="btn btn-light" role="button"> Change Fair</a>
